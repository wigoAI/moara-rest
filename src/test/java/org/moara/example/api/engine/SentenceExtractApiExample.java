...
/** 
 * <pre>
 *  파 일 명 : SentenceExtractApiExample.java
 *  설    명 : 예제용 문장 추출 api
 *         
 *  작 성 자 : malce(김용수)
 *  작 성 일 : 2018.06
...
public class SentenceExtractApiExample {
...
//			obj.put("documentType", "SNS");
			...
			//제목 입력
			obj.put("title","5월 ‘고용 쇼크’…정부도 “매우 충격적”");
			
			//본문입력 제목이나 본문 둘중에 하나는 입력해야 결과가 돌아옴.
			String contents = " 지난달 취업자 증가수가 7만2000여명에 그치면서 고용쇼크가 연속 이어지고 있다. 8년4개월 만에 최악의 수준이라는 분석이다. \n "+
			...
			result = request.sendToReceiveMessage("SentenceExtract", obj.toString());
			...
			for(int i=0 ; i<length ; i++){
				...
				//lineNumber, sentence, userType, sttOffSet, point, isTitle, isImportant

				System.out.println(jSONObject.getInt("lineNumber"));
				System.out.println(jSONObject.getString("sentence"));
